...
// const Footer = () => {
//   return (
//     <div className="border border-t-[#01CFFF] flex w-full p-10 gap-[42px] mx-auto">
//       <div className="text-white w-[558px] bg-red-600">
//         <Image src={"/assets/logo.png"} alt="Logo" width={200} height={200} />
//         <div className="mt-[56px]">
//           <span className="font-[500] text-[12px]">Newsletter</span>
//           <div className="flex">
//             <input
//               type="text"
//               placeholder="Email"
//               className="placeholder-[#656565] rounded-tl-[8px] rounded-bl-[8px] w-[240px] h-[40px] bg-[#F9F9F9] px-[18px] outline-none text-black"
//             />
//             <button className="w-[121px] h-[40px] bg-[#01CFFF] text-black text-[12px] font-[500] rounded-tr-[8px] rounded-br-[8px]">
//               SUBSCRBE
//             </button>
//           </div>
//         </div>

//         <h2 className="font-[500] text-[20px] mt-[56px] mb-[31px]">
//           info@techloset.com
//         </h2>

//         <div className="flex flex-col gap-[12px]">
//           <h2 className="font-[500] text-[20px] text-[#01CFFF]">Follow Us</h2>
...
//       <div className="w-[558px] flex justify-between bg-red-500">
